...
# correlation 
correlation <- cor(Train_B[,c("fbbeforebase", "fbrelativeto base","fbT1toT2","fb 1st 24hrs","fbdif52and53","tbT1toT2",
                              "tb 1st 24hrs","tbdif52and53","monday","tuesday","wednesday","thursday","friday","saturday","sunday",
...
library(ggplot2)
hist(Train_B$fbtarget, breaks = 1000, xlim = c(51:61) )
